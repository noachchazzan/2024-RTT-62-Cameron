package GLAB303_10_3;
    ...
    /* This approach not only promotes code reuse (with shared methods and properties) but also enforces a contract that
    each shape must calculate an area, though the method to do so varies by shape.*/